...
public class DustParser implements PsiParser {
  ...
  public ASTNode parse(IElementType root_, PsiBuilder builder_, LanguageVersion _languageVersion) {
    ...
    if (root_ == ATTR_STRING) {
      ...
      result_ = tag_content(builder_, level_ + 1);
    }
    else if (root_ == TAG_NAME) {
      result_ = tag_name(builder_, level_ + 1);
    }
    else {
  ...
  private static boolean attrString_0_1(PsiBuilder builder_, int level_) {
    ...
    while (result_) {
      ...
      if (offset_ == next_offset_) {
        empty_element_parsed_guard_(builder_, offset_, "attrString_0_1");
        break;
      }
  ...
  private static boolean attrString_0_1_0_1(PsiBuilder builder_, int level_) {
    ...
    while (result_) {
      ...
      int next_offset_ = builder_.getCurrentOffset();
      if (offset_ == next_offset_) {
        empty_element_parsed_guard_(builder_, offset_, "attrString_0_1_0_1");
        break;
      }
      offset_ = next_offset_;
    }
  ...
  public static boolean attribute(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, CRLF) && !nextTokenIs(builder_, IDENTIFIER)
  ...
  private static boolean i18nFormat_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      int next_offset_ = builder_.getCurrentOffset();
      if (offset_ == next_offset_) {
        empty_element_parsed_guard_(builder_, offset_, "i18nFormat_1");
        break;
      }
      offset_ = next_offset_;
    }
  ...
  private static boolean index_deref_1_1(PsiBuilder builder_, int level_) {
    ...
    while (result_) {
      ...
      int next_offset_ = builder_.getCurrentOffset();
      if (offset_ == next_offset_) {
        empty_element_parsed_guard_(builder_, offset_, "index_deref_1_1");
        break;
      }
      offset_ = next_offset_;
    }
  ...
  private static boolean json_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      int next_offset_ = builder_.getCurrentOffset();
      if (offset_ == next_offset_) {
        empty_element_parsed_guard_(builder_, offset_, "json_1");
        break;
      }
      offset_ = next_offset_;
    }
  ...
  private static boolean key_tag_3(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      int next_offset_ = builder_.getCurrentOffset();
      if (offset_ == next_offset_) {
        empty_element_parsed_guard_(builder_, offset_, "key_tag_3");
        break;
      }
      offset_ = next_offset_;
    }
  ...
  private static boolean open_tag_4(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      int next_offset_ = builder_.getCurrentOffset();
      if (offset_ == next_offset_) {
        empty_element_parsed_guard_(builder_, offset_, "open_tag_4");
        break;
      }
      offset_ = next_offset_;
    }
  ...
  public static boolean path(PsiBuilder builder_, int level_) {
    ...
    if (!nextTokenIs(builder_, IDENTIFIER) && !nextTokenIs(builder_, PERIOD)
        && replaceVariants(builder_, 2, "<path>")) return false;
    boolean result_ = false;
  ...
  private static boolean path_0_2(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      int next_offset_ = builder_.getCurrentOffset();
      if (offset_ == next_offset_) {
        empty_element_parsed_guard_(builder_, offset_, "path_0_2");
        break;
      }
      offset_ = next_offset_;
    }
  ...
  private static boolean self_close_tag_2(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      int next_offset_ = builder_.getCurrentOffset();
      if (offset_ == next_offset_) {
        empty_element_parsed_guard_(builder_, offset_, "self_close_tag_2");
        break;
      }
      offset_ = next_offset_;
    }
  ...
  private static boolean tag_content_0(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      int next_offset_ = builder_.getCurrentOffset();
      if (offset_ == next_offset_) {
        empty_element_parsed_guard_(builder_, offset_, "tag_content_0");
        break;
      }
      offset_ = next_offset_;
    }
  ...
  private static boolean tag_content_1(PsiBuilder builder_, int level_) {
    ...
    while (true) {
      ...
      int next_offset_ = builder_.getCurrentOffset();
      if (offset_ == next_offset_) {
        empty_element_parsed_guard_(builder_, offset_, "tag_content_1");
        break;
      }
      offset_ = next_offset_;
    }
